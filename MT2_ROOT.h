...
class ComputeMT2 {
 public:
  ...
  inline ComputeMT2(TLorentzVector visa, TLorentzVector visb, TLorentzVector MET, TString name1, TString name2){
  ...
  ~ComputeMT2();
  double Compute() ;
  inline std::pair <double,double> get_solutions(){
    if (myMT2 < 0){
...
inline ComputeMT2::ComputeMT2(TLorentzVector visa, TLorentzVector visb, TLorentzVector MET, double ma, double mb) {
  
  Init(visa, visb, MET, ma, mb);

}

inline void ComputeMT2::Init(TLorentzVector visa, TLorentzVector visb, TLorentzVector MET, double ma, double mb) {
...
inline ComputeMT2::~ComputeMT2() {
}

inline double ComputeMT2::Compute()  {
...
inline double ComputeMT2::particletype(TString part){
...
inline void ComputeMT2::listparticles(){
